...
function OfferCard({
  ...
  offer: (typeof prestationPricing)[number];
  isSelected: boolean;
  onToggle: () => void;
}) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ maxHeight: isSelected ? `${height}px` : "0px" }}
        className={`overflow-hidden transition-all duration-500 ease-out ${isSelected ? "mt-4 opacity-100" : "opacity-0"}`}
      >
        <div ref={contentRef}>
